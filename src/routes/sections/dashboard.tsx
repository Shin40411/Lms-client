...
const ChatChannelPage = lazy(() => import('src/pages/dashboard/chat/channels'));
const ChatGroupPage = lazy(() => import('src/pages/dashboard/chat/groupchat'));
...
export const dashboardRoutes: RouteObject[] = [
  {
    ...
    children: [
      ...
      { path: 'channel', element: <ChatChannelPage /> },
      { path: 'chat-group', element: <ChatGroupPage /> },
